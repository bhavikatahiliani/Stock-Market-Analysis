...
WORKDIR /app  # Changed the working directory to match the copied application code directory
...
# CMD ["python", "stock_market.main:app", "--bind", "0.0.0.0:5000"]  # Updated the path to the Flask application file
